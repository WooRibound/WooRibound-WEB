      ...
      <div class="job-posting-wrap">
        ...
        <div class="job-posting-list" v-for="corporateUser in corporateUserList" :key="corporateUser">
          ...
          <div class="course-schedule">
            <div class="schedule-info">{{ corporateUser.endAddr }}</div>
            <img src="@/assets/images/icons/rightarrows.png" class="right-arrow-icon" alt="Right Arrow Icon" @click="onMoveDetailPageClick(corporateUser.userId)">
          </div>
        </div>
      </div>
    </div>
